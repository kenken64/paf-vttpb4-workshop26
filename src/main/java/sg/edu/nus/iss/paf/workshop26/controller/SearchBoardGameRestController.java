package sg.edu.nus.iss.paf.workshop26.controller;
...
import sg.edu.nus.iss.paf.workshop26.models.Games;
import sg.edu.nus.iss.paf.workshop26.services.SearchBGGService;

@RestController
@RequestMapping("/api/bgg")
public class SearchBoardGameRestController {
    @Autowired
    private SearchBGGService bggSearchService;

    @GetMapping(path="/games")
    public ResponseEntity<String> getAllGames(
        @RequestParam Integer limit, @RequestParam Integer offset){
        List<Game> results = bggSearchService.searchGame(limit, offset);
    ...
    public ResponseEntity<String> getGamesByRanking(){
        ...
        List<Game> results = bggSearchService.getGamesByRank();
    ...
    {
        JsonObject result = null;
        Game gameDetails = bggSearchService.getGameDetails(gameId);
        JsonObjectBuilder objBuilder = Json.createObjectBuilder();
    ...
    public ResponseEntity<String> searchComment(
        ...
        List<Comment> results = bggSearchService.searchComment(q, score, 20, 0);
        JsonArray result = null;
        JsonArrayBuilder arrBuilder = Json.createArrayBuilder();
